...
# Database: adb_project2
# Generation Time: 2017-05-04 07:42:00 +0000
# ************************************************************
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_totalrentrecord`
AS SELECT
